...
public class TBSBlockTagsProvider extends FabricTagsProvider.BlockTagsProvider {
    public TBSBlockTagsProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {
