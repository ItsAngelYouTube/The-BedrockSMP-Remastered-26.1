...
public class TBSItemTagsProvider extends FabricTagsProvider.ItemTagsProvider {
    public TBSItemTagsProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {
